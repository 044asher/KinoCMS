...
public class FilmServiceTest {
    ...
    public void testGetCurrentFilms() {
        ...
        assertEquals("Test Film", currentFilms.get(0).getName());
    ...
    public void testGetUpcomingFilms() {
        ...
        assertEquals("Test Film", upcomingFilms.get(0).getName());
    ...
    public void testGetPrePremieresFilms() {
        ...
        assertEquals("Test Film", prePremieresFilms.get(0).getName());
    ...
    public void testFindAll() {
        ...
        assertEquals("Test Film", allFilms.get(0).getName());
    ...
    public void testProcessFilmData() throws IOException {
        ...
        assertEquals("Producer", film.getProducer().get(0));
        assertEquals("Director", film.getDirector());
        assertEquals("Writer", film.getWriter().get(0));
        assertEquals("Genre", film.getGenre().get(0));
