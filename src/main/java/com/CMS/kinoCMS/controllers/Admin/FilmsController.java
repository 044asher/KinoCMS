...
public class FilmsController {
    ...
    public String addFilm(Model model) {
        ...
        model.addAttribute("selectedFilmTypes", new String[]{});
    ...
    public String addFilmPost(@Valid Film film,
        ...
        if (filmTypes == null || filmTypes.isEmpty()) {
            bindingResult.rejectValue("types", "error.film", "Выберите хотя бы один тип кино.");
            model.addAttribute("allFilmTypes", List.of("2D", "3D", "IMAX"));
